criarCartao(
    ...
    'Bíblia',
    'Quem usou um cajado para abrir o Mar Vermelho?',
    'Moisés')

    criarCartao(
    'Bíblia',
    'Quem sobreviveu dentro de uma cova cheia de leões?',
    'Daniel')

    criarCartao(
    'Bíblia',
    'Quem construiu uma arca para sobreviver ao dilúvio?',
    'Noé')

    criarCartao(
    'Bíblia',
    'Qual foi o primeiro milagre que Jesus fez?',
    ...
    criarCartao(
    'Bíblia',
    'De acordo com a palavra de Deus, Jesus é?',
    ...
    criarCartao(
    'Bíblia',
    'Qual o nome que Jesus deu para Saulo?',
    'Paulo')
